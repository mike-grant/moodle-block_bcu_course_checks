<?php
/**
Language file for the Your Course block, defining strings to be used in the block. 
From tutorial at http://docs.moodle.org/dev/Blocks
Called from the init() in the main block file /moodle/blocks/yourcourse/block_bcu_your_course.php
*/
...
$string['topmodulenotes'] = 'Module notes (To Appear Above)';
$string['bottommodulenotes'] = 'Module Notes (To Appear Underneath)';
